...
@push('scripts')
    ...
    <script src="{{ asset('assets/js/widgets/visitor-chart.js') }}"></script>
    <script src="{{ asset('assets/js/widgets/income-overview-chart.js') }}"></script>
    <script src="{{ asset('assets/js/widgets/analytics-report-chart.js') }}"></script>
    <script src="{{ asset('assets/js/widgets/sales-report-chart.js') }}"></script>
                ...
                <div class="col-md-6 col-xl-3">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="mb-0 text-muted text-sm">
                                You made an extra
                                <span class="text-success">8,900</span>
                                this year
                            </p>
                        </div>
                    </div>
                ...
                <div class="col-md-6 col-xl-3">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="mb-0 text-muted text-sm">
                                You made an extra
                                <span class="text-warning">1,943</span>
                                this year
                            </p>
                        </div>
                    </div>
