...
@section('content')
    <section class="pc-container">
        <div class="pc-content">
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-12">
                            <div class="page-header-title">
                                <h2 class="mb-0">Tambah Tahun Ajaran</h2>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <form action="{{ route('student-management.school-years.store') }}" method="POST">
                @csrf
                <div class="card">
                    <div class="card-body">
                        <x-input id="year_label" type="text" name="year_label" value="{{ old('year_label') }}"
                            label="Tahun Ajaran" placeholder="Tahun Ajaran" required />

                        <x-input id="start_date" type="date" name="start_date" value="{{ old('start_date') }}"
                            label="Tahun Ajaran Dimulai" placeholder="Tahun Ajaran Dimulai" required />

                        <x-input id="end_date" type="date" name="end_date" value="{{ old('end_date') }}"
                            label="Tahun Ajaran Selesai" placeholder="Tahun Ajaran Selesai" required />
